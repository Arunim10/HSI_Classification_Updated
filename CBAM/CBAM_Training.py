...
def train():
    ...
    data_initial = balanced_data.sample(frac=0.3, random_state=9)
    ...
    # model.load_state_dict(torch.load(r"D:\HSI Project\Updated_Work\HSI_Classification\CBAM\cbam_model.pth"))
    model = model.to(device)
    
    
    # ************************************************** Training *************************************************
    epoch = 5
    model,train_loss,val_loss,train_fscore,val_fscore = train_model(model,train_dl,valid_dl,epoch,device,1e-3,1e-6)
